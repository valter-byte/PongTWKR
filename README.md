...
# How to use?
Well, as for January 28, 2026, PongTWKR is still on early development. v0.3. It is a simple CLI program that makes it easier to make changes/tweaks to CPU/RAM configurations, such as governor, dirty_ratio, etc. Just install (Move pongtwkr.py to /usr/local/bin, /usr/bin or any other PATH directorie) and use it by the terminal!

# Questions? Bugs? You broke your computer?
Tell me, and please send me a screenshot
